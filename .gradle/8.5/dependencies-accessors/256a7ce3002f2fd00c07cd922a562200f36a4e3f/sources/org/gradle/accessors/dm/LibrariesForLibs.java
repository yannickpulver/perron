...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxDatabindingLibraryAccessors extends SubDependencyFactory {
         ...
         * with version '7.3.1'.
            ...
            public Provider<MinimalExternalModuleDependency> getViewbinding() {
                return create("androidx.databinding.viewbinding");
        }
    ...
    public static class AndroidxWearLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxWearWatchfaceLibraryAccessors getWatchface() {
            return laccForAndroidxWearWatchfaceLibraryAccessors;
        }
    ...
    public static class AndroidxWearWatchfaceLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxWearWatchfaceComplicationsLibraryAccessors getComplications() {
            return laccForAndroidxWearWatchfaceComplicationsLibraryAccessors;
        }
    ...
    public static class AndroidxWearWatchfaceComplicationsLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxWearWatchfaceComplicationsDataLibraryAccessors getData() {
            return laccForAndroidxWearWatchfaceComplicationsDataLibraryAccessors;
        }
    ...
    public static class AndroidxWearWatchfaceComplicationsDataLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxWearWatchfaceComplicationsDataSourceLibraryAccessors getSource() {
            return laccForAndroidxWearWatchfaceComplicationsDataSourceLibraryAccessors;
        }
    ...
    public static class AndroidxWearWatchfaceComplicationsDataSourceLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidx.wear.watchface'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("androidx.wear.watchface.complications.data.source.ktx");
        }
    ...
    public static class KotlinParcelizeLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'org.jetbrains.kotlin'.
            ...
            public Provider<MinimalExternalModuleDependency> getCompiler() {
                return create("kotlin.parcelize.compiler");
        }
    ...
    public static class KotlinxCoroutinesLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'org.jetbrains.kotlinx'.
             * This dependency was declared in catalog libs.versions.toml
             */
